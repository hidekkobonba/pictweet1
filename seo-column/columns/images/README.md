...
| `case-dango-front.jpg` | 団子鼻 症例・**正面**（術前｜術後） | 縦長 4:5（例 1080×1350） | Before/After合成でOK |
| `case-dango-oblique.jpg` | 団子鼻 症例・**斜め**（術前｜術後） | 縦長 4:5 | 同上 |
| `case-dango-side.jpg` | 団子鼻 症例・**横**（術前｜術後） | 縦長 4:5 | 同上 |
| `case-ryubi-front.jpg` | 隆鼻 症例・**正面**（術前｜術後） | 縦長 4:5 | 用意でき次第 |
| `case-ryubi-oblique.jpg` | 隆鼻 症例・**斜め**（術前｜術後） | 縦長 4:5 | 用意でき次第 |
| `case-ryubi-side.jpg` | 隆鼻 症例・**横**（術前｜術後） | 縦長 4:5 | 用意でき次第 |
